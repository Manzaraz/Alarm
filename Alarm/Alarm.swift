...
//  Alarm
//
//  Created by Christian Manzaraz on 22/07/2023.
//  Copyright © 2023 AppDev Training. All rights reserved.
//
...
extension Alarm: Codable {
    ...
    private static let alarmURL: URL = {
        guard let baseURL = FileManager.default.urls(
            ...
            in: .userDomainMask).first else { fatalError("Can't get URL for documents directory.") }
